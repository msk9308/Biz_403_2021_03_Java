...
public class ScoreVO extends Object{
	...
	//재정의
	//상속받은 클래스에 있는 method를 
	// 내맘대로 다시 만들어 쓰기
	
	//재활용
	//toString() method는 Object클래스로부터 상속받은
	//	모든 클래스로 만든 객체에서 호출 할 수 있다
	//VO클래스에서는 VO의 변수들에 담긴 값을
	//	 확인하는 용도로 재정의하여 활용한다
	@Override
