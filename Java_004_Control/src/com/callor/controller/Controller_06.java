 ...
 *모두 파일로 제공하고
 *필요에따라 Import하여 사용할 수 있도록 하고 있다
 *
 *import java.util.Random;
 *지금부터 Controller_06클래스에서
 *java.util 패키지의 Random 클래스 라는 도구를
 *사용하여 코딩을 하겠다라는 선언
 *
 * eclipse에서 도구를 사용하기 위해서
 * import하고자 할때는
 * ctrl + shift + o 를 눌러주면된다
 * 
 * 코드의 모양을 정렬하기 
 * ctrl + shift + f 
 */
