 ...
 * 인터페이스를 impl 한 클래스는 인터페이스에 설게된 
 * 추상메소드를 반드시 자신이 만들 클래스에서 구현해야 한다.
 * 그러한 규칙을 강제 하므로써 연결, 연동의 혼란을 최소화 하는것이다 
 */
/*
 * 키보드로 정수를 입력받기 위한 나만의 클래스 
 * 키보드로 정수를 입력받으면서
