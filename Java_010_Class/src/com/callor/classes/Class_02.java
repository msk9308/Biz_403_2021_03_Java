...
public class Class_02 {
	...
	public static void main(String[] args) {
		...
		intList.add(100);	//intList 의 size가 1이 되고 자동으로 0번 위치에 100이 저장된다
