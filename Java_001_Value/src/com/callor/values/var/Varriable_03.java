...
public class Varriable_03 {
	...
	public static void main(String[] args) {
		...
		// num1 변수와 num2변수에 어떤값이 저장되어 있는지
		// 		관심없다
		// 모두 제거하고 num1에는 150을, num2에 250을 저장하라
		num1 = 150;
		num2 = 250;
		
		/*
		 * 프로그래밍에서  할당연산자 = , 일치연산자 ==
		 * 할당연산자는 변수에 어떤값을 저장할 때
		 * 		변수 = 값
		 * 		변수 = 연산식
		 * 		변수 = 변수
		 * 
		 ...
		 * 변수는 선언할 때 반드시 어떤 값을 저장해 주는것이 좋다
		 * 
		 * 만약 저장될 값이 아직 정해지지 않았다면
		 * 0을 저장하자
		 */
		// 정수형 값을 저장할 변수 num3 선언하고
		// 0으로 clear 한다.
		// ==> 변수선언 초기화라고 한다
		// ==> 변수생성 이라고 한다
		int num3 = 0;
