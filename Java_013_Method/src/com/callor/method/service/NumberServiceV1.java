...
public class NumberServiceV1 {
	 ...
	 * 		int와 Integer가 있다 
	 * 
	 * return의 두번째 조건에 "아니면 null값을 return"하라는
	 * 		지시가 있으므로 int형은 사용할 수 없다
	 * 
	 * void키워드는
	 * 		method에 return 명령이 꼭 없어도 되는 경우
	 * 
	 * 이 메소드는 정수형 3의 배수 또는 null값을 return 해야 하기때문에 
	 ...
	 * 
	 * method에 오류가 나는것을 없애기 위해 return문을 추가한다
	 * 이 method는 return 명령문만으로 처리가 되지않고
	 * 		반드시 return할 값(대상)이 있어야 한다.
	 * 
	 * primitive type중에 숫자형인 경우는 0을
	...
	public Integer inputNum() {
		...
		if(num2 % 3 == 0) {
			 ...
			 * 		Integer 이다
			 * 그런데 여기에서 retrun하는 num2 변수의 type은
			 * 		int 형이다
