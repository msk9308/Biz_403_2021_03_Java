...
public class LocalDate_01 {
	...
	public static void main(String[] args) {
		/*
		 * java 1.8부터 사용할 수 있는 새로운 날자 관련 클래스
		 * 기존에 Date,Calendar클래스가 있는데 날짜와 관련된 많은 이슈가 발생한다
		 * java 1.8부터 새로운 날짜 시간과 관련된 코딩을 할때 사용하는 클래스가 만들어 졌다 
		 */
		...
		System.out.println(local.plusDaye(3));
