 ...
 * 	프로젝트
 * 
 *  소매점(도매점 등으로부터 구매하여 일반 소비자에게 판매)
 *  도매점(생산공장에서 구매하여, 소매점에 판매)
 *  
 *  기본적으로 필요한 데이터 항목
 *  객체지향 이론에서 추상화(단계)라고 한다 
 *  상품이름(pname)String, 거래일자(date) 2021-03-31 String, 거래처(dname) String, 매입매출구분(inout)String
 *  수량(qty) Integer , 매입단가(iprice) Integer, 매출단가(oprice)Integer
 *  
 */
